...
interface AdminAddBlogPostModalProps {
  onAdded: () => void;
}

export default function AdminAddBlogPostModal({ onAdded }: AdminAddBlogPostModalProps) {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-slate-800 border-slate-700">
        <div className="mb-6">
          ...
          <DialogDescription className="text-slate-400 text-sm mt-1">
            Create a new blog post. Upload a photo, set the header, content, date, author, and category.
          </DialogDescription>
        </div>
