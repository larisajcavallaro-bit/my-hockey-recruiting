...
export const getGrammarData: Grammar[] = [
  {
    id: 1,
    ...
    questions: [
      ...
      },
      {
        id: 5,
        type: "short-answer",
        question: "Correct the sentence: 'She go to school every day.'",
      ...
      },
      {
        id: 6,
        type: "true-false",
        question: "The plural of 'mouse' is 'mouses'.",
        correctAnswer: false,
        explanation: "The correct plural is 'mice'.",
        userAnswer: undefined,
        isCorrect: undefined
      },
      {
        id: 7,
        type: "fill-blank",
        question: "I have ___ my homework already.",
        correctAnswer: "done",
        explanation: "Use 'done' for the present perfect tense.",
        userAnswer: undefined,
        isCorrect: undefined
      },
      {
        ...
        choices: [
          ...
          { id: "C", text: "There be many students in the class." },
          { id: "D", text: "There was many students in the class." }
        ],
        correctAnswer: "B",
        explanation: "'There are' is correct for plural nouns in present tense.",
        userAnswer: undefined,
        isCorrect: undefined
      },
      {
        id: 9,
        type: "short-answer",
        question: "Rewrite correctly: 'I can able to swim.'",
        correctAnswer: "I can swim.",
        explanation: "The verb 'can' already expresses ability, no 'able' needed.",
        userAnswer: undefined,
        isCorrect: undefined
      },
      {
        id: 10,
        type: "true-false",
        question: "The sentence 'I have seen him yesterday.' is correct.",
        correctAnswer: false,
        explanation: "Use simple past for 'yesterday': 'I saw him yesterday.'",
        userAnswer: undefined,
        isCorrect: undefined
      }
    ]
  ...
  // 5th exercise
  {
    ...
    questions: [
      ...
      },
      {
        id: 6,
        type: "true-false",
        question: "'Spill the beans' means to reveal a secret.",
        correctAnswer: true,
        explanation: "Correct meaning of the idiom.",
        userAnswer: undefined,
        isCorrect: undefined
      },
      {
        id: 7,
        type: "fill-blank",
        question: "To 'bark up the ___' means to make a wrong assumption.",
        correctAnswer: "wrong tree",
        explanation: "Common idiom usage.",
        userAnswer: undefined,
        isCorrect: undefined
      },
      {
        id: 8,
        type: "short-answer",
        question: "Explain 'Hit the sack'.",
        correctAnswer: "Go to sleep.",
        explanation: "Idiomatic expression meaning.",
        userAnswer: undefined,
        isCorrect: undefined
      },
      {
        id: 9,
        type: "multiple-choice",
        question: "Choose correct: 'Once in a blue moon' means?",
        choices: [
      ...
      },
      {
        id: 10,
        type: "true-false",
        question: "'Let the cat out of the bag' means to keep a secret.",
        correctAnswer: false,
