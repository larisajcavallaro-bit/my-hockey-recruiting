...
/** POST - add admin reply to player dispute */
export async function POST(
  ...
  try {
    ...
    console.error("Admin player dispute reply error:", error);
    return NextResponse.json(
...
/** PATCH - update player review dispute status (admin only) */
export async function PATCH(
  ...
  try {
    ...
    await prisma.playerReviewDispute.update({
      where: { id },
    ...
    console.error("Admin player dispute update error:", error);
    return NextResponse.json(
