      ...
      <Tabs defaultValue="about" className="w-full">
        ...
        <TabsContent value="about" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4 text-sub-text3">
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-primary font-medium">{exp.team}</p>
                    </div>
              ...
              <Card key={idx}>
                <CardContent className="pt-6">
                  <div className="space-y-3">
                    <div className="flex items-start justify-between">
                      <div>
                        <h4 className="font-semibold text-sub-text1">
                          {review.author}
                        </h4>
                    ...
                    <p className="text-muted-foreground text-sub-text3">
                      {review.text}
                    </p>
                  </div>
                </CardContent>
